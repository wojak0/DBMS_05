...
-- 3. Insert Members (Handling the default dates)
INSERT INTO mitglied (mitglied_id, nachname, vorname, geburtsdatum, email) 
VALUES (1, 'Berger', 'Jonas', '2001-04-12', 'jonas.berger@mail.de');

INSERT INTO mitglied (mitglied_id, nachname, vorname, geburtsdatum, email, beitritt_datum) 
VALUES (2, 'Sommer', 'Klara', '1985-11-30', 'klara.sommer@web.de', '2019-03-15');

INSERT INTO mitglied (mitglied_id, nachname, vorname, geburtsdatum, email) 
VALUES (3, 'Hartmann', 'Lea', '1998-07-08', 'lea.hartmann@example.com');
